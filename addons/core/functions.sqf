...
hfgb_fnc_patHead = {
    ...
    [[name _unit, "STR_HFGB_Core_PattedYourHead" call BIS_fnc_localize], tsp_fnc_hint] remoteExec ["call", _target];
...
hfgb_fnc_bonkHead = {
    ...
    [_unit, "", "tsp_animate_shoulder_wnon_laut", "", "tsp" in gestureState _unit, true, true] spawn tsp_fnc_gesture_play;
    [[name _unit, "STR_HFGB_Core_BonkedYourHead" call BIS_fnc_localize], tsp_fnc_hint] remoteExec ["call", _target];
    [_unit, 5, "", 0] call tsp_fnc_animate_effect;
    sleep 0.3; 
