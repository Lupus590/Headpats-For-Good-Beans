...
["hfgb_sound_bonk_volume", "SLIDER", ["Bonk Sound Volume", "Sound effect volume for head bonking. (The actual volume is also affected by TSP Animate's volume slider.)"], "Headpats For Good Beans", [0, 10, 5], 2, false] call CBA_fnc_addSetting;
